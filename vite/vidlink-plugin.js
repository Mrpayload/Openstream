// vite/vidlink-plugin.js
// Server-side Vite plugin that proxies requests to VidLink API
// This mirrors the behavior of api/extract/vidlink.js for local development.
...
export default function vidlinkPlugin() {
  return {
    name: "vidlink-plugin",
    configureServer(server) {
      server.middlewares.use("/api/extract/vidlink", async (req, res) => {
        if (req.method !== "GET") {
